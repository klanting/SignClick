...
public class GsonTests {
    ...
    void saveLoadCompanies(){
        ...
        accountsPreSave.get("A").getCompanyValue().setTotalShares(100);
        ...
        assertEquals(0, comp.getCompanyValue().getBal());
        ...
        assertEquals(100, comp.getCompanyValue().getTotalShares());
