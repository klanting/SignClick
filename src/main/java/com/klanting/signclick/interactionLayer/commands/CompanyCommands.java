...
import com.klanting.signclick.interactionLayer.commands.companyHandelers.contractHandlers.*;
...
public class CompanyCommands implements CommandExecutor, TabCompleter {
    ...
    public static final List<String> whitelist = Arrays.asList("info", "sharetop", "give", "buy", "sell", "pay", "spendable",
            ...
            "sign_contract_ctp", "send_contract_ptc", "get_buy_price", "get_sell_price", "get_contracts", "open_trade", "transact", "color");
